...
namespace LRS.ViewAnimation
{
    public class UnityFactory : IUnityFactory
    {
        ...
        private void Initialize()
        {
            ...
            _unityContainer.RegisterType<IProductRepository, ProductRepository>();
            ...
            _unityContainer.RegisterType<IWorld, World>();
            _unityContainer.RegisterType<IRobotManager, RobotManager>();
            //_unityContainer.RegisterType<ILogisticalProcessingUnit<IView>, LogisticalProcessingUnit<MainWindow>>();
